...
export default function App() {
  ...
  // Replace CSS hidden classes (hidden lg:block and lg:hidden) with JS conditional rendering.
  // This prevents React from maintaining multiple instances of heavy components (like WorkoutTimer and Clock)
  // in the virtual DOM and running their background intervals (like setInterval) when they are not visible.
  // Expected Impact: Reduces memory footprint and CPU usage on all devices by destroying unneeded components.
