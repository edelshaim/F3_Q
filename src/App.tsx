...
export default function App() {
  ...
  const handleRandomize = async () => {
    ...
    try {
      ...
      // ⚡ Bolt: Replaced O(N log N) sort with O(N) partial Fisher-Yates shuffle
      // for significantly faster random selection from the large exercises dataset (~890 items).
