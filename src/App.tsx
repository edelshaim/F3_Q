...
export default function App() {
  ...
  // ⚡ Bolt Optimization: Use JS-based media queries instead of CSS (hidden lg:block)
  // Why: Prevents React from instantiating duplicate heavy component trees (like Clock and AnimatePresence) in the background.
  // Impact: Reduces initial DOM nodes, lowers memory footprint, and prevents redundant state updates/intervals (e.g. 2 clocks ticking simultaneously).
