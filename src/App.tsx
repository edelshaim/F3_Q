...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0f1115] text-slate-100 pb-24 lg:pb-8">
      ...
      <div className="max-w-6xl mx-auto p-4 md:p-8 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="lg:sticky lg:top-8 space-y-8">
            ...
            {/* PERFORMANCE OPTIMIZATION: Conditionally render based on JS media query to avoid mounting duplicate components and running redundant background intervals/re-renders. */}
            {isDesktop && (
      ...
      {/* PERFORMANCE OPTIMIZATION: Conditionally render to avoid duplicate DOM nodes and background work. */}
      {!isDesktop && (
